...
encoder_output2, forward_h2, forward_c2, backward_h2, backward_c2  = encoder_lstm2(enc_emb)
#encoder lstm 3
...
encoder_outputs, forward_h, forward_c, backward_h, backward_c  = encoder_lstm3(enc_emb)
